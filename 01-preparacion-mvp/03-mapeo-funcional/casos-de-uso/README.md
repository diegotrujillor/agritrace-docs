...
| [CU-11](CU-11-ver-detalle-lote-timeline.md) | Ver detalle de lote + timeline de actividades | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | **Bug P1 auth-refresh cerrado** en v1.4.1 (`b82d6a4`). Lote-detail rinde sin "Credenciales incorrectas". Obs P3: probe cold-start agresivo en relaunch |
| [CU-12](CU-12-editar-lote-status.md) | Editar lote (cambio de status planning→growing→ready→harvested) | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Pantalla edit + menú overflow. Commit `3e0ac0e`. Retest E2E: Planificación→En crecimiento persistió |
| [CU-13](CU-13-eliminar-lote.md) | Eliminar lote (cascada: las actividades desaparecen) | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Menú overflow + AlertDialog con copy cascada. Commit `3e0ac0e`. UI verificada E2E |
| [CU-14](CU-14-registrar-actividad.md) | Registrar actividad (los 6 tipos) | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Bug P1 ISO UTC (fix v1.3.6) confirmado E2E sobre v1.4.1: "Siembra · 20/05/2026" persistió |
| [CU-15](CU-15-ver-timeline-actividades.md) | Ver timeline ordenado por fecha | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Actividad renderiza en timeline con icono+fecha; EmptyState antes/después OK |
| [CU-16](CU-16-editar-actividad.md) | Editar actividad (fecha, descripción, foto) | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Edit screen + long-press bottom sheet. Commit `9843e4d`. E2E: sheet Editar/Eliminar OK. Edición destructiva — documentado |
| [CU-17](CU-17-eliminar-actividad.md) | Eliminar actividad | MUST | ✅ pasa (v1.4.1) | 2026-05-20 | Long-press → bottom sheet → AlertDialog. Commit `9843e4d`. E2E: confirmó borrado, timeline vacío |
| [CU-18](CU-18-crear-recordatorio-manual.md) | Crear recordatorio manual con scheduled_for | SHOULD | ✅ pasa (v1.4.1) | 2026-05-20 | Fix ISO UTC (`scheduledFor`) confirmado E2E: "Fertilizar Lote A · 21/05/2026" creado y listado |
| [CU-19](CU-19-chequear-clima-lote.md) | Chequear clima del lote → genera alerta weather si umbral cruzado | SHOULD | ✅ pasa (v1.4.1) | 2026-05-20 | Acción "Actualizar clima" + snackbar "Clima actualizado". Commit `9d64d5f`. E2E OK. Provider real + cron post-pilot |
| [CU-20](CU-20-listar-alertas-sync-badge.md) | Listar alertas + sync status badge | SHOULD | ✅ pasa (v1.4.1) | 2026-05-20 | Pantalla 13 + badge + acción "Actualizar clima" + FAB. Recordatorio listado/EmptyState OK |
| [CU-21](CU-21-descartar-eliminar-alerta.md) | Descartar/eliminar alerta | SHOULD | ✅ pasa (v1.4.1) | 2026-05-20 | Long-press → Descartar/Eliminar + `AlertDialog`; al confirmar vuelve a "Sin alertas" |
