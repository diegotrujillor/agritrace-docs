...
| [CU-12](CU-12-editar-lote-status.md) | Editar lote (cambio de status planning→growing→ready→harvested) | MUST | ✅ pasa (v1.4.0) | 2026-05-20 | Pantalla edit + ruta + menú overflow. Commit `3e0ac0e`. Retest E2E bloqueado por [[CU-11]] |
| [CU-13](CU-13-eliminar-lote.md) | Eliminar lote (cascada: las actividades desaparecen) | MUST | ✅ pasa (v1.4.0) | 2026-05-20 | Menú overflow + AlertDialog con copy cascada. Commit `3e0ac0e` |
...
| [CU-16](CU-16-editar-actividad.md) | Editar actividad (fecha, descripción, foto) | MUST | ✅ pasa (v1.4.0) | 2026-05-20 | Edit screen + long-press bottom sheet. Commit `9843e4d`. Edición destructiva — documentado |
| [CU-17](CU-17-eliminar-actividad.md) | Eliminar actividad | MUST | ✅ pasa (v1.4.0) | 2026-05-20 | Long-press → bottom sheet → AlertDialog. Commit `9843e4d` |
...
| [CU-19](CU-19-chequear-clima-lote.md) | Chequear clima del lote → genera alerta weather si umbral cruzado | SHOULD | ✅ pasa (v1.4.0) | 2026-05-20 | Acción "Actualizar clima" AppBar `alerts_screen` + spinner + snackbar. Commit `9d64d5f`. Provider real + cron post-pilot |
