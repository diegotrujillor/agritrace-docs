# 03 - Pitch de 30 segundos y de 2 minutos

**Objetivo**: dos scripts cortos que un ingeniero introvertido puede memorizar y entregar con autenticidad. Sin lenguaje de vendedor. Sin promesas exageradas. Sin "cierre de venta".

**Audiencia**: pequeño productor agrícola en Valle del Cauca (cacao, café, frutas, hortalizas, caña panelera).

---

## Principio

> Eres un ingeniero que construyó una herramienta y necesita aprender si funciona. No eres un vendedor.
> Esto no es manipulación; es honesto. Y precisamente por eso funciona mejor.

---

## Pitch de 30 segundos (llamada telefónica inicial)
...
## Pitch de 2 minutos (cuando dicen "muéstrame")

**Uso**: dentro de la call de 15 min, después de que el prospecto aceptó escuchar. Antes de mostrar la app/demo.

```
Construí AgriTrace porque vi que pequeños productores pierden
dinero en dos momentos:

Primero, cuando no pueden documentar bien la calidad de lo que
producen y terminan vendiendo barato porque no tienen pruebas.

Segundo, cuando llega un comprador formal que pide trazabilidad
o certificación, y el productor no tiene cómo entregarla porque
todo está en cuadernos, almanaques o en la memoria.

Lo que hace AgriTrace es simple: el productor documenta cada
actividad en su celular —siembra, riego, químicos, cosecha—
con fecha, foto y nota. Funciona sin internet, los datos quedan
guardados en el teléfono, y cuando hay señal se sincronizan solos.
...
## Disclaimer breve sobre disartria (si aplica)

Si sientes que necesitas anticipar la disartria leve, **una sola frase al principio basta**, sin disculpas excesivas:

```
Antes de empezar: a veces me como alguna palabra sin querer,
es una secuela leve. Si pasa, repito y seguimos. ¿Vale?
```
...
- Beneficio inesperado: humaniza inmediatamente y rompe la barrera vendedor/comprador

---

## Adaptaciones por sub-segmento (Valle del Cauca)
...
## Ensayo (antes de primera call real)

1. Lee el pitch de 30s en voz alta 5 veces
2. Grábate en celular y escúchate
3. Cronometra: debe estar entre 25-35 segundos
4. Practica con esposa (rol comprador)
5. Practica una variante con disartria intencional (para que no te asuste si pasa)

**Meta**: poder decirlo sin leer, en tono natural, en menos de 35 segundos.

---

## Referencias

- Estructura de validación: [`05-guion-call-validacion.md`](05-guion-call-validacion.md)
- Canales donde usarás este pitch: [`02-canales-acceso.md`](02-canales-acceso.md)
- Sub-segmentos para personalizar: [`01-icp-y-segmentacion.md`](01-icp-y-segmentacion.md)
